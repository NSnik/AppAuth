...
//                conn.setRequestProperty("User-Agent", "student-app");
                ...
                conn.setRequestProperty("client_secret", "$2y$10$kVWdBZ83FGDVzrQFL/UhouNfRhZdHZthqfr.RXbQRW6EOPXFxAWpa");
...
//                String queryData = UriUtil.formUrlEncode(parameters);
                ...
                for (String key : keys) {
                    ...
                    queryData += key + "=" + parameters.get(key);
                }
